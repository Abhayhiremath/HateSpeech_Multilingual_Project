...
def run():
    ...
    joblib.dump(vec, os.path.join(OUT, "kannada_gru_tfidf.pkl"))
    ...
    print("\n[Kannada GRU] Validation Report:\n")
    print(classification_report(true, preds))

    with open(os.path.join(OUT, "kannada_gru_report.json"), "w") as f:
        json.dump(rep, f, indent=2)

    torch.save(model.state_dict(), os.path.join(OUT, "kannada_gru.pt"))
    print("✔ Kannada GRU model saved to", OUT)
